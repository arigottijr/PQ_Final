...
public class AnimateIn : MonoBehaviour
{
    ...
    public TextMeshProUGUI displayArtistName;
    ...
    public class fgCSVReader
{
    ...
    public void ComeIn(int artistNumber)
    {
        ...
        displayCategoryandName.text = myArtistList[artistNumber].artistCat;
        displayArtistName.text = myArtistList[artistNumber].artistName;
